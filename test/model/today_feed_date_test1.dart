...
void main() {
  ...
  test('insert date cards between different days', () {
    ...
    var pali = PaliWordCardModel(id: "b4285e6a-ea3c-4fc1-a7f4-4de3f1ed8ca4", url: "https://something", publishedDate: thisWeek, publishedAt: thisWeek, isBookmarkable: true, isShareable: true);
    var doha = DohaCardModel(id: "f9a2cc0f-915f-4a9a-a049-77bbb9be1fc7", url: "https://something", publishedDate: thisWeek, publishedAt: lastWeek, isBookmarkable: true, isShareable: true);
